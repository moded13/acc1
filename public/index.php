...
$routes = [
	...
	'GET' => [
        ...
        '/sales-invoices/print'           => ['App\Controllers\WebSalesInvoicesController', 'print'],
    ...
    'POST' => [
        ...
        // مسارات الإدخال والترحيل لفواتير المبيعات
        '/sales-invoices/store'           => ['App\Controllers\WebSalesInvoicesController', 'store'],
        '/sales-invoices/post'            => ['App\Controllers\WebSalesInvoicesController', 'post'], // <-- تم تعديلها إلى post بدلاً من postInvoice
